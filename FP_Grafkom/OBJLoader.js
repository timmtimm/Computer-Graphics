    ...
    parse: function (text) {
        ...
        for (var i = 0, l = lines.length; i < l; i++) {
            ...
            if (lineFirstChar === "v") {
                ...
                if (
                    (result = this.regexp.face_vertex_uv_normal.exec(line)) !==
                    null
                ) {
                    // f vertex/uv/normal vertex/uv/normal vertex/uv/normal
                    ...
                    (result = this.regexp.face_vertex_uv.exec(line)) !== null
                ) {
                    // f vertex/uv vertex/uv vertex/uv
                    // 0                  1    2    3    4    5    6   7          8
                    ...
                    (result = this.regexp.face_vertex_normal.exec(line)) !==
                    null
                ) {
                    // f vertex//normal vertex//normal vertex//normal
                    // 0                     1    2    3    4    5    6   7          8
                    ...
                    (result = this.regexp.face_vertex.exec(line)) !== null
                ) {
                    // f vertex vertex vertex
                    // 0            1    2    3   4
                ...
                (result = this.regexp.object_pattern.exec(line)) !== null
            ) {
                // o object_name
                // or
                // g group_name
                ...
                (result = this.regexp.smoothing_pattern.exec(line)) !== null
            ) {
                // smooth shading
