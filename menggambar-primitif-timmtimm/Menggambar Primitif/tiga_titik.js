function main() {
     ...
     */
    const canvas = document.getElementById('myCanvas_tiga_titik');
    ...
    const vertexShaderCode = document.getElementById('vertexShaderCode_tiga_titik').text;
    ...
    const fragmentShaderCode = document.getElementById('fragmentShaderCode_tiga_titik').text;
