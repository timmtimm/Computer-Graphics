function kotak(){
     ...
     */
     const canvas = document.getElementById('myCanvas_kotak');
    ...
    var vertexShaderCode = document.getElementById("vertexShaderCode_kotak").text;
    ...
    var fragmentShaderCode = document.getElementById("fragmentShaderCode_kotak").text;
